  ...
  return (
    <footer id="contact" className="relative w-full pt-16 pb-28 px-6 text-center bg-neutral-200 dark:bg-neutral-950 overflow-hidden">
      ...
      <div className="pointer-events-none">
        <div className="blur-3xl bg-cyan-600 dark:bg-cyan-500/70 w-[60%] min-w-[200px] aspect-[4/3] rounded-full absolute top-[100%] left-[40%] -translate-x-2/4" />
        <div className="blur-3xl bg-purple-500 dark:bg-purple-500/70 w-[60%] min-w-[200px] aspect-[4/3] rounded-full absolute top-[100%] left-[60%] -translate-x-2/4" />
      </div>
    </footer>
  )
}
