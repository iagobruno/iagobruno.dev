...
export default function Footer () {
  return (
    <>
      <footer id="contact" className="w-full py-20 px-6 text-center bg-neutral-200 dark:bg-neutral-950">
        ...
        <a href="https://github.com/iagobruno/iagobruno.github.io" className="w-fit flex items-center mx-auto mt-6 gap-1 text-stone-600 dark:text-stone-400 text-sm opacity-80">
