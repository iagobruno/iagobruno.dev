...
export default function PageHeader({ overline, subHeading, heading }: Props) {
  return (
    <header className="pt-6 pb-4 dark:text-white not-prose max-w-(--max-content-width) mx-auto">
