...
export default function Footer () {
  ...
  return (
    <>
      <footer className="fixed z-0 left-0 bottom-0 w-full pt-28 pb-18 px-safe-offset-6 text-center bg-neutral-200/50 dark:bg-neutral-900/80 overflow-hidden" ref={footerRef}>
        <div className="max-w-(--max-content-width) mx-auto">
          ...
          <div className="mt-7 mx-auto w-fit flex items-center gap-x-2 gap-y-3 not-sm:flex-col text-stone-600 dark:text-stone-400 text-xs opacity-80">
            <a href="https://github.com/iagobruno/iagobruno.dev" className="inline-flex items-center gap-1 relative z-10">
            ...
            <a href="https://github.com/iagobruno/iagobruno.dev/releases">Changelog</a>
          </div>
        </div>
      </footer>
