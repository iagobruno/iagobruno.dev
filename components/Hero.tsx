...
function Photo() {
  return (
    <div className="relative order-1 md:order-2">
      <img src="/me.JPEG" className="rounded-full aspect-1/1 w-[260px] md:w-[340px] xl:w-[420px] border-[6px] bg-white border-white shadow-lg relative z-10 animate-[morph_8s_ease-in-out_infinite] will-change-[border-radius]" />
