export default function () {
  ...
  return (
    <div className="flex items-center m-2 fixed! bottom-safe-offset-0 right-0 border border-gray-400 rounded-sm p-1 px-2 bg-gray-300 text-black text-xs z-100!">
      <svg className="size-5 w-auto inline" viewBox="0 0 80 64" fill="none" xmlns="http://www.w3.org/2000/svg">
