  ...
  return (
    ...
    >
      <header className="px-6 pt-4.5 pb-4 flex-1 flex flex-col">
        ...
        <p className="text-sm mt-2 opacity-85 flex-1">{description}</p>
        ...
        <div className="flex justify-between -mx-1 mt-3">
          {link && (
            <MiniButton
              href={link}
              target="_blank"
              className="origin-left group-has-[.card-link:hover]/card:bg-primary dark:group-has-[.card-link:hover]/card:bg-white group-has-[.card-link:hover]/card:text-white dark:group-has-[.card-link:hover]/card:text-black group-has-[.card-link:hover]/card:scale-105 group-has-[.card-link:active]/card:!scale-95"
            >
              Ver demo
            </MiniButton>
          )}
          {repo && (
            <MiniButton
              ...
              target="_blank"
              className={cn(
                '!z-10 origin-right hover:bg-primary hover:text-white dark:hover:bg-white dark:hover:text-black hover:scale-105 active:!scale-95',
                {
                  'group-has-[.card-link:hover]/card:bg-primary dark:group-has-[.card-link:hover]/card:bg-white group-has-[.card-link:hover]/card:text-white dark:group-has-[.card-link:hover]/card:text-black group-has-[.card-link:hover]/card:scale-105 group-has-[.card-link:active]/card:!scale-95':
                    !link,
                },
              )}
            >
      ...
      {(link || repo) && (
        <a
          href={link || repo}
          target="_blank"
          className="card-link absolute inset-0 z-5"
        ></a>
      )}
...
const MiniButton = ({ children, className, href }) => (
  <a
    className={cn(
      'inline-flex items-center gap-1 rounded-full hover:scale-105 focus:outline-none transition bg-white dark:bg-gray-50/10 text-black dark:text-white shadow-md dark:shadow-lg shadow-black/20 text-xs font-medium pr-3 pl-3.5 py-2 no-underline! relative',
      className,
    )}
    href={href}
    target="_blank"
